...
export function PriceList({ sqftPrice = 546 }: { sqftPrice?: number }) {
  const calc = (sqft: number) => `₹ ${Math.round(sqft * sqftPrice).toLocaleString('en-IN')}`;
  ...
  return (
    <section className="bg-white rounded-3xl p-6 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 mb-16 mt-8">
      <div className="flex justify-center items-center mb-10 relative">
        ...
        <div className="relative z-[1] bg-[#0B1A2A] text-white px-6 md:px-10 py-3 rounded-xl font-heading text-2xl md:text-3xl font-extrabold tracking-widest shadow-lg border-2 border-white flex items-center gap-4 text-center">
          <span className="text-[#7cb93e] text-xl md:text-2xl hidden md:inline">◀</span>
          PRICE LIST <span className="text-lg md:text-xl font-medium tracking-normal whitespace-nowrap">(₹{sqftPrice}/Sq.Ft)</span>
          <span className="text-[#7cb93e] text-xl md:text-2xl hidden md:inline">▶</span>
        </div>
      </div>
        ...
        <div className="flex flex-col rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-white">
          ...
          <div className="flex flex-col text-sm font-semibold text-center divide-y divide-gray-100">
            <div className="grid grid-cols-3 py-3 hover:bg-blue-50/50 transition-colors">
              ...
              <div className="text-[#055bc7]">{calc(15.00)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-blue-50/50 transition-colors">
              ...
              <div className="text-[#055bc7]">{calc(15.63)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-blue-50/50 transition-colors">
              ...
              <div className="text-[#055bc7]">{calc(18.00)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-blue-50/50 transition-colors">
              ...
              <div className="text-[#055bc7]">{calc(18.75)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-blue-50/50 transition-colors">
              ...
              <div className="text-[#055bc7]">{calc(19.50)}</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-white">
          ...
          <div className="flex flex-col text-sm font-semibold text-center divide-y divide-gray-100 h-full">
            <div className="grid grid-cols-3 py-3 hover:bg-green-50/50 transition-colors flex-1">
              ...
              <div className="text-[#599c15] flex items-center justify-center">{calc(24.00)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-green-50/50 transition-colors flex-1">
              ...
              <div className="text-[#599c15] flex items-center justify-center">{calc(25.00)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-green-50/50 transition-colors flex-1">
              ...
              <div className="text-[#599c15] flex items-center justify-center">{calc(26.00)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-green-50/50 transition-colors flex-1">
              ...
              <div className="text-[#599c15] flex items-center justify-center">{calc(28.00)}</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-white">
          ...
          <div className="flex flex-col text-sm font-semibold text-center divide-y divide-gray-100 h-full">
            <div className="grid grid-cols-3 py-3 hover:bg-purple-50/50 transition-colors flex-1">
              ...
              <div className="text-[#782c7a] flex items-center justify-center">{calc(30.00)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-purple-50/50 transition-colors flex-1">
              ...
              <div className="text-[#782c7a] flex items-center justify-center">{calc(31.25)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-purple-50/50 transition-colors flex-1">
              ...
              <div className="text-[#782c7a] flex items-center justify-center">{calc(32.50)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-purple-50/50 transition-colors flex-1">
              ...
              <div className="text-[#782c7a] flex items-center justify-center">{calc(35.00)}</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-white">
          ...
          <div className="flex flex-col text-sm font-semibold text-center divide-y divide-gray-100 h-full">
            <div className="grid grid-cols-3 py-3 hover:bg-orange-50/50 transition-colors flex-1">
              ...
              <div className="text-[#eb7407] flex items-center justify-center">{calc(36.00)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-orange-50/50 transition-colors flex-1">
              ...
              <div className="text-[#eb7407] flex items-center justify-center">{calc(37.50)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-orange-50/50 transition-colors flex-1">
              ...
              <div className="text-[#eb7407] flex items-center justify-center">{calc(39.00)}</div>
            </div>
            <div className="grid grid-cols-3 py-3 hover:bg-orange-50/50 transition-colors flex-1">
              ...
              <div className="text-[#eb7407] flex items-center justify-center">{calc(42.00)}</div>
            </div>
          </div>
        </div>
