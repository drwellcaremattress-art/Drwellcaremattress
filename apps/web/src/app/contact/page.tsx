    ...
    <div className="min-h-screen bg-slate-50 flex flex-col pt-20 font-body">
      ...
      <section className="container mx-auto px-4 pb-16 sm:pb-20 max-w-6xl">
        ...
        <div className="w-full h-[450px] rounded-3xl overflow-hidden shadow-xl border border-slate-200">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3910.605674547909!2d80.1844535750794!3d13.14279238718852!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a52649df083458f%3A0x570c69f166e4dc62!2sDr.Well%20Care%20Mattress!5e1!3m2!1sen!2sin!4v1785317138440!5m2!1sen!2sin" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
